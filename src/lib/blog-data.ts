import { LucideIcon, Cpu, Brain, Activity, Settings } from "lucide-react";
...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "<blockquote class='border-l-4 border-brand pl-4 my-6 italic text-white bg-primary py-6 pr-2'>'A single hour of unplanned downtime on an automotive assembly line can cost upwards of $20,000. Deploying edge-processing vibration alerts provides immediate OEE improvements and pays back the installation investment in under 6 months.' — Director of R&D, AstroIntelli.</blockquote>",
...
export const blogPosts: Record<string, BlogArticle> = blogArticles.reduce((acc, current) => {
